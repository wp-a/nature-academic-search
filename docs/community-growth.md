...
|---|---:|---:|---|
| Qualified submissions | 0 | 8-12 | A target-specific PR, issue, or registry request that is actually open and permitted by the target's current contribution policy |
| Prepared nominations | 0 | >=1 | A complete human-review packet for a target that prohibits agent-filed submissions; preparation does not count as submitted |
